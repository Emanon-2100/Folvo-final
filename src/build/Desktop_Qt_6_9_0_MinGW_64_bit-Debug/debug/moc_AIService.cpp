...
void AIService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AIService::*)(const QString & )>(_a, &AIService::analysisComplete, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AIService::*)(const QString & )>(_a, &AIService::errorOccurred, 1))
            return;
    }
}
...
// SIGNAL 0
void AIService::analysisComplete(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void AIService::errorOccurred(const QString & _t1)
{
